...
public class GUISwimmingpool 
{
	...
	private void InitializeGUI() {
		...
		btnOpen.addActionListener(e -> {
			...
			new AdventurePool(buffer, lblAdvNr, lblAdvLim, 15);
			new CommonPool(buffer, lblComNr, lblComLim, 20);
			new Exit(buffer, lblAexit, lblCexit);
	...
	public static void main(String[] args) {
		GUISwimmingpool gui = new GUISwimmingpool();
		gui.Start();
	}
}
